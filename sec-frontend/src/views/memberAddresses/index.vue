    ...
    <el-card class="search-card" shadow="never">
      <el-form :inline="true" :model="queryForm">
        <el-form-item label="关键字">
          <el-input v-model="queryForm.keyword" placeholder="请输入联系人姓名/联系人电话" clearable style="width: 220px" @keyup.enter="handleSearch" />
        </el-form-item>
...
const handleSearch = () => {
  ...
  memberAddressStore.fetchList(buildParams())
}
const handleReset = () => {
