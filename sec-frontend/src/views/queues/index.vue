    ...
    <el-card class="search-card" shadow="never">
      <el-form :inline="true" :model="queryForm">
        <el-form-item label="关键字">
          <el-input v-model="queryForm.keyword" placeholder="请输入排队号/联系电话" clearable style="width: 220px" @keyup.enter="handleSearch" />
        </el-form-item>
...
// ===== 搜索专用：枚举选项 / 外键下拉数据 =====
const enumOptions = {
  status: [{ value: 1, label: '排队中' }, { value: 2, label: '已叫号' }, { value: 3, label: '已过号' }, { value: 4, label: '已就位' }, { value: 5, label: '已取消' }]
}
...
const handleSearch = () => {
  queueStore.page = 1
  queueStore.fetchList(buildParams())
}
const handleReset = () => {
