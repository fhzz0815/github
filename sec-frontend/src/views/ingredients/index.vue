    ...
    <el-card class="search-card" shadow="never">
      <el-form :inline="true" :model="queryForm">
        <el-form-item label="关键字">
          <el-input v-model="queryForm.keyword" placeholder="请输入原料名称" clearable style="width: 220px" @keyup.enter="handleSearch" />
        </el-form-item>
        ...
        <el-form-item label="原料类别">
          <el-select v-model="queryForm.categoryId" clearable filterable placeholder="全部" style="width: 150px">
            <el-option v-for="o in searchOptions.ingredientCategories" :key="o.id" :label="o.categoryName" :value="o.id" />
          </el-select>
        </el-form-item>
...
const loadSearchOptions = () => {
  ...
  ingredientCategoryApi.list({ page: 1, size: 1000 }).then((r) => { searchOptions.ingredientCategories = r.data?.list || [] }).catch(() => {})
}
loadSearchOptions()
...
const handleSearch = () => {
  ...
  ingredientStore.fetchList(buildParams())
}
const handleReset = () => {
